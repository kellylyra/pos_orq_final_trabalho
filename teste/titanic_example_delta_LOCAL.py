...
print(data.count())
# escreve parquet
write_parquet(data, parquet_folder_path, get_writemode())
...
write_parquet(new1, total_pas_sex_class, get_writemode())
total_pas_sex_classparquet = read_parquet(spark, total_pas_sex_class)
total_pas_sex_classparquet.show()
...
write_parquet(new2, media_preco_sex_class, get_writemode())
media_preco_sex_classparquet = read_parquet(spark, media_preco_sex_class)
media_preco_sex_classparquet.show()